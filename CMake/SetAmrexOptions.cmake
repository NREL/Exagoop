...
set(AMReX_SPACEDIM "${EXAGOOP_DIM}" CACHE STRING "Number of physical dimensions" FORCE)
set(AMReX_MPI ${EXAGOOP_ENABLE_MPI})
set(AMReX_OMP ${EXAGOOP_ENABLE_OPENMP})
set(AMReX_EB ${EXAGOOP_ENABLE_EB})
set(AMReX_PARTICLES ${EXAGOOP_ENABLE_PARTICLES})
set(AMReX_SUNDIALS OFF)
set(AMReX_FORTRAN OFF)
set(AMReX_FORTRAN_INTERFACES OFF)
set(AMReX_PIC OFF)
set(AMReX_PRECISION "${EXAGOOP_PRECISION}" CACHE STRING "Floating point precision" FORCE)
...
elseif(EXAGOOP_ENABLE_SYCL)
  ...
  set(AMReX_SYCL_ONEDPL ${EXAGOOP_ENABLE_SYCL})
else()
