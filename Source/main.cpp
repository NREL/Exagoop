  ...
  amrex::Initialize(argc,argv);
  {
    ...
    if(specs.restart_checkfile !="")												//Restart from checkpoint solution
    ...
    else
      {
        ...
        PrintMessage(msg,print_length,true);
        mpm_pc.InitParticles(specs.autogen_mincoords.data(),
                             specs.autogen_maxcoords.data(),
                             specs.autogen_vel.data(),
                             specs.autogen_dens,
                             specs.autogen_constmodel,
                             specs.autogen_E,specs.autogen_nu,
                             specs.autogen_bulkmod,
                             specs.autogen_Gama_pres,
                             specs.autogen_visc,
